  ...
  const gerarCronograma = () => {
    ...
    Object.entries(pesos).forEach(([bloco, peso]) => {
      ...
      for (let i = 0; i < materias.length; i++) {
        ...
        const tempoMateria = restante >= 90 ? 30 : restante >= 60 ? 20 : 15;
        const quantidadeTopicos = tempoMateria >= 90 ? 3 : tempoMateria >= 60 ? 2 : 1;
        const topicosSelecionados = [...materias[i].topicos]
            ...
            <div className="space-y-2">
              ...
              {blocos.map((bloco, idx) => (
                ...
                >
                  ...
                  <span className="italic">Assuntos: {bloco.topicos.join(', ')}</span>
                </button>
              ))}
            </div>
          )}
        ...
        <div className="text-center space-y-4">
          {!telaEscura && (
            <>
              ...
              <p className="text-lg">Tópico(s): {blocoSelecionado.topicos.join(', ')}</p>
              ...
              <div className="flex gap-4 justify-center">
                ...
                <button onClick={() => { setTelaEscura(true); setMostrarConfirmar('reset');
                  setTimeout(() => setMostrarConfirmar('reset-buttons'), 3000); }} className="bg-purple-600 px-4 py-2 rounded-xl">🔁 Resetar</button>
