...
(Fácil de cair na prova — se um estiver com problema, o ato pode ser anulado)
...
• Discricionários: o agente tem liberdade dentro da lei para decidir como agir.
...
♻️ Revogação
Quando o ato é legal, mas a administração decide não manter (por conveniência ou oportunidade).
...
Cassação | O particular não cumpre as condições do ato.
...
Exemplo real: A Administração exonerou alguém “a pedido”, mas na verdade foi por punição = ilegal!
A motivação tem que bater com a realidade.
...
📘 1. INTRODUÇÃO
Os poderes administrativos são instrumentos jurídicos que autorizam a Administração a agir em nome do interesse público.

Não são privilégios pessoais, e sim deveres funcionais — a Administração tem que agir, mas com limites.
...
🛡️ 2. PODER VINCULADO
📌 Conceito:
É quando a lei determina exatamente o que deve ser feito.
O agente não pode escolher como agir.

🧠 Todos os elementos do ato (competência, finalidade, forma, motivo e objeto) estão determinados em lei.

📍Exemplo:
Conceder aposentadoria compulsória a servidor que completou 75 anos — é obrigatório, não opcional.

🎓 PODERES ADMINISTRATIVOS – AULA 02
Tema: Poder Discricionário

⚖️ 1. PODER DISCRICIONÁRIO
📌 Conceito:
Quando a lei permite certa margem de escolha (conveniência e oportunidade), dentro dos limites legais.

🧠 Elementos com margem de decisão:
...
Finalidade, competência e forma são sempre vinculadas.

📍Exemplo:
Autorização para evento em praça pública — o agente avalia se o local e o horário são adequados.

🚫 Discricionariedade ≠ Arbitrariedade
Discricionariedade = liberdade legal.

Arbitrariedade = abuso de poder.

👨‍⚖️ 2. CONTROLE DO PODER DISCRICIONÁRIO
O Judiciário não pode substituir a escolha do administrador.
...
🎓 PODERES ADMINISTRATIVOS – AULA 03
Tema: Poder Hierárquico

🧩 1. PODER HIERÁRQUICO
📌 Conceito:
Permite a organização interna da Administração, com base na relação de subordinação.

Permite:

Delegar e avocar funções

Fiscalizar e punir subordinados

Distribuir competências

🔀 Delegação x Avocação
Termo	O que é
Delegar	Superior transfere parte da sua competência a subordinado
Avocar	Superior assume competência do subordinado, de forma excepcional

❌ Limites:
Não pode delegar atos de competência exclusiva

Não pode avocar competência exclusiva de outro
...
📌 Conceito:
Permite aplicar sanções a servidores públicos ou a particulares com vínculo jurídico.

🧠 Só se aplica quando há um vínculo prévio.

🧹 Exemplo:
Servidor comete falta → advertência, suspensão, demissão.

Empresa que descumpre contrato com a Administração → penalidade contratual.

❌ Não se confunde com:
Poder de Polícia (que pune sem vínculo)

Poder Judiciário (que aplica sanções penais ou civis)

🎓 PODERES ADMINISTRATIVOS – AULA 05
Tema: Poder Regulamentar

📘 1. PODER REGULAMENTAR
📌 Conceito:
É a capacidade da Administração de expedir normas gerais para complementar a lei.

🧠 Só pode regulamentar, nunca criar obrigações novas.

🏛️ Tipos de Regulamentos:
Tipo	Característica
Executivo	Complementa leis, mais comum.
Autônomo	Independe de lei, só possível no art. 84, VI da CF. Só pode tratar de:
...
🎓 PODERES ADMINISTRATIVOS – AULA 06
Tema: Poder de Polícia

🚓 1. PODER DE POLÍCIA
📌 Conceito:
Poder de restringir ou condicionar direitos individuais, para proteger o interesse coletivo.
...
Fase	O que é
Ordem de polícia	Lei que estabelece os limites
Consentimento	Licença ou autorização
Fiscalização	Ato de verificação, inspeção
Sanção	Multas, interdições, apreensões

🛠️ Atributos do Poder de Polícia
Atributo	Significado
Autoexecutoriedade	Pode agir sem ordem judicial (ex: fechar bar irregular)
Coercibilidade	Pode usar meios de força legalmente previstos
Discricionariedade	Pode escolher como e quando agir (dentro da lei)

👨‍🏫 Exemplo clássico:
Fechar uma obra sem alvará, aplicar multa por som alto, remover barracas irregulares.

🆚 Poder de Polícia x Poder Disciplinar
Comparação	Polícia	Disciplinar
Vínculo com o punido	Não exige vínculo	Exige vínculo jurídico
Exemplo	Fechar bar irregular	Suspender servidor

🎓 PODERES ADMINISTRATIVOS – AULA 07
Tema: Abuso de Poder

🚫 1. ABUSO DE PODER
📌 Conceito:
Ocorre quando o agente ultrapassa os limites legais ou usa o poder com finalidade errada.

Tipos:
Tipo	O que é
Excesso de poder	O agente atua fora da sua competência legal.
Desvio de finalidade	O agente usa o poder para interesse pessoal, e não público.

🧨 Consequência:
Ato é nulo

Pode gerar responsabilização civil, penal e administrativa

⚠️ Abuso de poder ≠ erro administrativo
Erro: pode ser corrigido.

Abuso: é grave, intencional, com desvio de função.
